...
```bash
python scripts/run_rlhf.py --model_name gpt2 --config src/config.yaml
```
...
```bash
python scripts/evaluate.py --base_model gpt2 --rlhf_model outputs/rlhf_model --config src/config.yaml
```
