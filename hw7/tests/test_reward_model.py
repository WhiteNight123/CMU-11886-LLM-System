...
class TestRewardModel:
    ...
    def test_get_rewards(self, model_and_tokenizer):
        ...
        rewards = model.get_rewards(texts, batch_size=2)
    ...
    def test_save_and_load_model(self, model_and_tokenizer, tmp_path):
        ...
        texts = ["Test input"]
        original_rewards = model.get_rewards(texts)
        loaded_rewards = loaded_model.get_rewards(texts)
...
class TestRewardModelIntegration:
    ...
    def test_different_text_lengths(self):
        ...
        rewards = model.get_rewards(texts)
